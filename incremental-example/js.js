...
document.getElementById("buy_click").onclick = function() {
    ...
    update_total_clicks();
    var clicks_per_second = document.getElementById("clicks_per_second");
    clicks_per_second.innerHTML = auto_clicks;
    var buy_click = document.getElementById("buy_click");
    buy_click.innerHTML = 'Buy for ' + cost;
    var auto_level = document.getElementById("autoclicker_level");
    auto_level.innerHTML = 'lvl  ' + auto_clicks;
};
